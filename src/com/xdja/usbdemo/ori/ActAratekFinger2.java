...
import com.xdja.usbdemo.ui.TitleBar;
...
public class ActAratekFinger2 extends Activity implements View.OnClickListener {
    ...
    FingerprintUsbDevices fud = FingerprintUsbDevices.instance(this);
    ...
    private void updateFingerprintImage(FingerprintImage fi) {
        ...
        if (fi != null && (fpBmp = fi.convert2Bmp()) != null && 
            ...
            imageView1.setImageResource(R.drawable.no_finger_print);
        }
    }
